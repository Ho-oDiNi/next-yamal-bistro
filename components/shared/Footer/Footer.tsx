...
const Footer = () => {
    return (
        <footer className="relative flex items-center justify-center bg-[#EBEBEB] p-(--space-outside-container-accent) text-xl font-normal">
            <div className="mx-auto h-auto w-full max-w-420 rounded-[26px] bg-white px-(--space-inside-x) py-12">
                <div className="container mx-auto">
                    <div className="flex justify-between">
                        <ul className="mr-8 max-w-[30%]">
                        ...
                        <ul className="mr-8 flex max-w-[20%] flex-col justify-between">
                        ...
                        <div className="flex max-w-[30%] flex-col">
                            <p className="px-2">
                                Скачайте наше мобильное приложение и получите
