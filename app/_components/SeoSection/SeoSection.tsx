...
const SeoSection = () => {
    return (
        <section className="to-brand-primary body-secession-regular-22 after-image after-image-deer relative bg-gradient-to-b from-[#007dc6] px-48 py-12 text-white">
