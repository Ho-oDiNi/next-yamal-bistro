...
const ReservationSection = () => {
    return (
        <section
            ...
            className="relative flex aspect-1440/895 w-full items-center justify-center bg-[url(/images/reservation.png)] bg-cover bg-center bg-no-repeat p-(--space-container) text-white"
        >
