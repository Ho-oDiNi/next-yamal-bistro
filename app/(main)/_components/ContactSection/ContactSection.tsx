...
const ContactSection = () => {
    return (
        <section
            id="section-contacts"
            className="relative flex items-center justify-center bg-[#EBEBEB] p-(--space-outside-container-accent)"
        >
            <div className="mx-auto h-auto w-full max-w-420 rounded-[26px] bg-white p-(--space-intside-container)">
                <div className="container mx-auto">
                    <h2>Наши контакты</h2>
                    <div className="flex flex-col justify-between not-italic lg:flex-row">
                        <div className="flex justify-between not-italic lg:max-w-[52%]">
                        ...
                        <iframe
                            ...
                            className="mt-8 ml-8 h-[320px] w-[385px] rounded-[26px] shadow-md lg:flex-1"
